...
CKEDITOR.stylesSet.add('default', [
    ...
    {'name': 'List Checked', 'element': ['ul', 'ol'], 'attributes': {'class': 'list-checked'}},
    ...
    /* Inline Styles */
    {'name': 'Depart Page Button', 'element': 'cms-plugin', 'attributes': {'class': 'inner-depart-page-link'}},
    {'name': 'Depart Menu Button', 'element': 'cms-plugin', 'attributes': {'class': 'left-nav-button'}},
